#Область ОбработчикиСобытийЭлементовТаблицыФормыДокументыНаПолныйРасчет
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыДокументыНаАванс
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыДокументыНаВозврат
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыДокументыНаЗачетАванса
...
Функция ПолучитьНастройкиЗаполнения(НастройкиЗаполнения, ИдентификаторНастройки)
	...
	Исключение
		...
		ТекстСообщения = СтрШаблон(ШаблонСообщения, ИдентификаторНастройки, ОписаниеОшибки());
...
Процедура ДокументыНаПолныйРасчетЗаполнитьНаСервере()
	...
	НастройкаАтолОнлайн = Неопределено;
	Если Не ПолучитьНастройкиЗаполнения(НастройкаАтолОнлайн, "НастройкиАтолОнлайн") Тогда
		Возврат;
	КонецЕсли;
	...
	Если Не ПолучитьНастройкиЗаполнения(Соединение, НастройкаАтолОнлайнПоОрганизации) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ДокументыНаЗачетАвансаЗаполнитьНаСервере()
	...
	Если Не ПолучитьНастройкиЗаполнения(ДополнительныеНастройки, "НастройкиАтолОнлайнДопСвойства") Тогда
		Возврат;
	КонецЕсли;
