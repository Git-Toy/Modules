...
Функция ПодключитьАТОЛОнлайн(ИдентификаторНастройки, Организация, ОписаниеОшибок)
	...
	ПолучатьТокенПриКаждомОбмене = Неопределено;
	Если НастройкиАтолОнлайн.Свойство("ПолучатьТокенПриКаждомОбмене", ПолучатьТокенПриКаждомОбмене) Тогда
		Если ПолучатьТокенПриКаждомОбмене = Истина Тогда
