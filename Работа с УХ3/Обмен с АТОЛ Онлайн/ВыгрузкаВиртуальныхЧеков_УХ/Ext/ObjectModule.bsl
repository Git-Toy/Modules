...
Функция ЭкранироватьСпецсимволы(Знач ИсходнаяСтрока)
	...
	ЭкранированаяСтрока = СтрЗаменить(ЭкранированаяСтрока, "\", "\\");
	ЭкранированаяСтрока = СтрЗаменить(ЭкранированаяСтрока, Символы.ПС, "\n");
	ЭкранированаяСтрока = СтрЗаменить(ЭкранированаяСтрока, Символы.ВК, "\r");
	ЭкранированаяСтрока = СтрЗаменить(ЭкранированаяСтрока, Символы.Таб, "\t");
	ЭкранированаяСтрока = СтрЗаменить(ЭкранированаяСтрока, "/", "\/");
	ЭкранированаяСтрока = СтрЗаменить(ЭкранированаяСтрока, """", "\""");
	
	Возврат ЭкранированаяСтрока;
...
Функция ОтправитьВиртуальныйЧек(ВиртуальныйЧек, Соединение, ТипОперации, ОписаниеОшибок)
	...
	Если ПолучитьЭлементСтруктуры(СтруктураОтвета, "uuid", ИдентификаторВиртуальногоЧека, "Строка") Тогда
		...
		Результат.Вставить("ДополнительныйРеквизит", ПараметрыЧека.ФискальныйПризнакОснования);
		Результат.Вставить("ТипРасчета", ПараметрыЧека.ТипРасчета);
		Результат.Вставить("СвойствоОнлайнОперация", Соединение.СвойствоОнлайнОперация);
		Результат.Вставить("ЗначениеОнлайнОперация", ПараметрыЧека.ЗначениеОнлайнОперация);
...
Функция ПолучитьРезультатОбработкиВиртуальногоЧека(
		ВиртуальныйЧек,
		ИдентификаторВиртуальногоЧека,
