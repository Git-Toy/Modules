...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    НоваяКоманда.Представление = СтрШаблон(НСтр("ru = '%1 (выполнить регламентное задание)'"), ПараметрыРегистрации.Наименование);
    НоваяКоманда.Идентификатор = ЭтотОбъект.Метаданные().Имя + "_РегламентноеЗадание";
	НоваяКоманда.ПоказыватьОповещение = Истина;
	
	НоваяКоманда = ПараметрыРегистрации.Команды.Добавить();
    НоваяКоманда.Использование = ДополнительныеОтчетыИОбработкиКлиентСервер.ТипКомандыОткрытиеФормы();
    НоваяКоманда.Представление = СтрШаблон(НСтр("ru = '%1 (открыть форму обработки)'"), ПараметрыРегистрации.Наименование);
...
Функция ЗаписатьФискальнуюОперацию(ФискальнаяОперация)
