...
Процедура ЗагрузитьФинансирование(Команда)
	...
	ИначеЕсли Вариант = 4 Тогда  //Промсвязьбанк
		ОписаниеОповещения = Новый ОписаниеОповещения("ПрочитатьЛистExcel_Финансирование_ПромСвязьБанк", ЭтотОбъект);
...
&НаКлиенте
Процедура ПрочитатьЛистExcel_Финансирование_ПромСвязьБанк(Результат, АдресФайла, ВыбранноеИмяФайла, ДополнительныеПараметры) Экспорт
