...
&НаКлиенте
Процедура ПрочитатьЛистExcel_Финансирование_Сбербанк(ТЗ = Неопределено, ЛистЭксель = Неопределено, НомерПервойСтроки = 1, НомерПервойКолонки = 1, ВсегоСтрок = 0, ВсегоКолонок = 0) Экспорт	
	Если Не ЗначениеЗаполнено(ФайлФинансирование) Тогда
...
&НаКлиенте
Процедура ПрочитатьЛистExcel_Финансирование_Райффайзен(ТЗ = Неопределено, ЛистЭксель = Неопределено, НомерПервойСтроки = 1, НомерПервойКолонки = 1, ВсегоСтрок = 0, ВсегоКолонок = 0) Экспорт	
	Если Не ЗначениеЗаполнено(ФайлФинансирование) Тогда
		Сооб = Новый СообщениеПользователю;
		Сооб.Текст = "Укажите путь к файлу!";
		Сооб.Поле = "Файл";
...
&НаКлиенте
Процедура ПрочитатьЛистExcel_Финансирование_Альфа(ТЗ = Неопределено, ЛистЭксель = Неопределено, НомерПервойСтроки = 1, НомерПервойКолонки = 1, ВсегоСтрок = 0, ВсегоКолонок = 0) Экспорт	
