...
&НаКлиенте
Процедура ПослеЗагрузкиФайлаФинансированияНаСервер(Результат, АдресФайла, ИмяФайла, ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ПослеЗагрузкиФайлаОстатковНаСервер(Результат, АдресФайла, ИмяФайла, ДополнительныеПараметры) Экспорт
