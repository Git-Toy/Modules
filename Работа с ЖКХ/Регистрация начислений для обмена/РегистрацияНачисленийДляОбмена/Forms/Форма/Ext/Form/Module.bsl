...
&НаКлиенте
Процедура СписокДокументовУстановитьФлажки(Команда)
	
	СписокДокументовУстановитьФлажкиНаСервере();
	
КонецПроцедуры

&НаКлиенте
Процедура СписокДокументовСнятьФлажки(Команда)
	
	СписокДокументовСнятьФлажкиНаСервере();
...
&НаСервере
Процедура СписокДокументовУстановитьФлажкиНаСервере()
	
	МассивОтобранныхДокументов = ПолучитьМассивОтобранныхДокументов();
	СписокВыбранныхДокументов.ЗагрузитьЗначения(МассивОтобранныхДокументов);
...
&НаСервере
Процедура СписокДокументовСнятьФлажкиНаСервере()
