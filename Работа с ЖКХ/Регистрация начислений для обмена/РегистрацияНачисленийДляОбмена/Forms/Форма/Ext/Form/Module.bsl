...
Процедура УстановитьОтборы()
	...
	Если ЗначениеЗаполнено(Здание) Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(СписокДокументов, "Здание", Здание, , , Истина);
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(СписокДокументов, "Здание", Здание, , , Ложь);
	КонецЕсли;
...
Процедура ИзменитьПометкуДокумента(Документ, Знач ТекущиеДанные)
	...
	СписокДокументов.КомпоновщикНастроек.Настройки.ДополнительныеСвойства.Вставить("ТаблицаВыбранныхДокументов", ТаблицаВыбранныхДокументов);
