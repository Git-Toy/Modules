...
Процедура Заполнить(Команда)
	...
	Если ПроверитьСуществованиеФайла() Тогда
		...
		НачатьПомещениеФайлов(ОписаниеОповещения, ИмяФайлаЗагрузки, , Ложь, УникальныйИдентификатор);
	КонецЕсли;
...
Функция ПроверитьСуществованиеФайла()
	...
	Если ПустаяСтрока(ИмяФайлаЗагрузки) Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстОшибки, , "ИмяФайлаЗагрузки");
		Возврат Ложь;
	КонецЕсли;
