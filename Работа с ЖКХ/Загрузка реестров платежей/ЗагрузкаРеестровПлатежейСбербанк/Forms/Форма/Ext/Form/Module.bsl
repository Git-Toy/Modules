...
Процедура ЗаполнитьТаблицу(АдресФайла)
	...
	КоличествоСтрокФайлаЗагрузки = МассивСтрокФайлаЗагрузки.Количество();
	...
	стрТекста = МассивСтрокФайлаЗагрузки.Получить(0);
	...
	Для номСтр = 0 По КоличествоСтрокФайлаЗагрузки - 2 Цикл
		стрТекста = МассивСтрокФайлаЗагрузки.Получить(номСтр);
		масЗначСтр = СтрРазделить(стрТекста, РазделительПолей, Истина);
	...
	Для Каждого Стр Из табЗагрузки1 Цикл
		...
		НовыйЭлементТабЗагрузки = Объект.ТаблицаЗагрузки.Добавить();
